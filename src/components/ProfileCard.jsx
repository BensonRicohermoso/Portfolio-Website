...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(() => ({
    ...
    '--behind-glow-color': behindGlowColor ?? 'rgba(255, 255, 255, 0.3)',
    ...
    '--sunpillar-1': 'hsl(2, 40%, 60%)',
    '--sunpillar-2': 'hsl(53, 40%, 55%)',
    '--sunpillar-3': 'hsl(93, 40%, 55%)',
    '--sunpillar-4': 'hsl(176, 40%, 60%)',
    '--sunpillar-5': 'hsl(228, 40%, 60%)',
    '--sunpillar-6': 'hsl(283, 40%, 58%)',
  ...
  const shineStyle = {
    ...
    filter: 'brightness(0.5) contrast(1.1) saturate(0.15) opacity(0.3)',
  ...
  const glareStyle = {
    ...
    overflow: 'hidden',
    backgroundImage: `radial-gradient(farthest-corner circle at var(--pointer-x) var(--pointer-y),hsl(0,0%,70%) 12%,hsla(0,0%,20%,0.6) 90%)`,
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="rounded-full overflow-hidden border border-white/10 flex-shrink-0" style={{ width: '32px', height: '32px' }}>
                      <img
                    ...
                    <div className="flex flex-col items-start gap-1">
                      ...
                      <div className="text-xs text-white/60 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-white/10 rounded px-2 py-0.5 text-[10px] font-medium text-white/80 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px"
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em' }}>
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '16px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #ffffff, #777777)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text'
